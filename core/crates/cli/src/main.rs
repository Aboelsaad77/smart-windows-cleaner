//! `sc-cleaner` — thin CLI over the Smart Cleaner core.
//!
//! This binary is also the future sidecar contract for the desktop UI
//! (milestone M2): the same operations will be exposed over IPC.
//!
//! Usage:
//!   sc-cleaner [--quick | --smart | --deep] [roots...]
