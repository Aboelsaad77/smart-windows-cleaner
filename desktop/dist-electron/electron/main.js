...
const ALLOWED_IPC_ACTIONS = new Set([
    'ping',
    'get_system_status',
    'get_scan_status',
    'get_settings',
        ...
        try {
            ...
            if (parsed && typeof parsed === 'object' && (parsed.type || parsed.event)) {
                if (mainWindow && !mainWindow.isDestroyed()) {
                    mainWindow.webContents.send('smart-cleaner:event', parsed);
                }
                return;
            }
...
electron_1.ipcMain.handle('smart-cleaner:ipc', async (_event, request) => {
